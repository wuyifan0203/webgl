...
function main() {
    ...
    const u_isClick = gl.getUniformLocation(gl.program,'u_isClick')
    ...
    canvasDom.addEventListener('click',(ev)=>{
        ...
        if(isInCanvas){
            ...
            const picked = checked(xInCanvas,yInCanvas);
            if(picked){
                alert('object is select!')
            }
        }
    })
